    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const body = {
                ...
                // In a real app, we'd pass payment token/details here
                paymentDetails: paymentMethod === "saved" ? { type: "saved" } : { type: "new", last4: cardNumber.slice(-4) }
            };
        ...
        return (
            <div style={styles.page}>
                <div style={styles.content}>
                    <div style={styles.error}>Invalid booking session. Please start over.</div>
                    <button onClick={() => router.push("/")} style={styles.primaryButton}>Go Home</button>
                </div>
            </div>
        )
    }
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div style={styles.muted}>
                                        {user.paymentCards[0].cardNumber} • {user.paymentCards[0].cardHolderName}
                                    </div>
                                </div>
                            </label>
                        )}
